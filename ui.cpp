...
void CUi::Update(void)
{
	...
	{
		Create(D3DXVECTOR3(UI_WINMARK_POS_LEFT2_X+50, UI_WINMARK_POS_Y, 0.0f), D3DXVECTOR3(UI_WINMARK_SIZE_X, UI_WINMARK_SIZE_Y+50, 0.0f), CUi::UYTYPE_WINMARK);
		Create(D3DXVECTOR3(UI_WINMARK_POS_RIGHT1_X+50, UI_WINMARK_POS_Y, 0.0f), D3DXVECTOR3(UI_WINMARK_SIZE_X, UI_WINMARK_SIZE_Y, 0.0f), CUi::UYTYPE_WINMARK);
		...
		Create(D3DXVECTOR3(UI_WINMARK_POS_RIGHT2_X, UI_WINMARK_POS_Y, 0.0f), D3DXVECTOR3(UI_WINMARK_SIZE_X, UI_WINMARK_SIZE_Y, 0.0f), CUi::UYTYPE_WIN);
	}
}
